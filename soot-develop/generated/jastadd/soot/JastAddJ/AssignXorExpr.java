 ...
 * @ast node
 * @declaredat /Users/eric/Documents/workspaces/clara-soot/JastAddJ/Java1.4Frontend/java.ast:126
 */
public class AssignXorExpr extends AssignBitwiseExpr implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public AssignXorExpr clone() throws CloneNotSupportedException {
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public AssignXorExpr copy() {
    try {
      AssignXorExpr node = (AssignXorExpr) clone();
      node.parent = null;
      if(children != null)
  ...
  public AssignXorExpr fullCopy() {
    AssignXorExpr tree = (AssignXorExpr) copy();
    if (children != null) {
   ...
   * @ast method 
   * @aspect Expressions
   * @declaredat /Users/eric/Documents/workspaces/clara-soot/JastAddExtensions/JimpleBackend/Expressions.jrag:183
   */
   ...
   * 
   */
  public AssignXorExpr(Expr p0, Expr p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /**
